...
class HashtagEditorController: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate {
    ...
    func setup() {
        ...
        tableView.register(NewHashtagTableCell.self, forCellReuseIdentifier: "editorCell")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "editorCell") as! NewHashtagTableCell
        ...
        if hashtags.count > 30 {
            ...
            if index == -1 {
                if tagsTitle.text!.isEmpty || hashtags.isEmpty {
                    ...
                    HashtagsController.sharedInstance.saveHashtags(tags)
                ...
                if tagsTitle.text!.isEmpty || hashtags.isEmpty {
                    ...
                    HashtagsController.sharedInstance.saveHashtagsToIndex(tags: tags, index: index)
    ...
    func removeTagsFromHome(at: Int) {
        ...
        let toRemove = HashtagsController.sharedInstance.hashtags[at]
        HashtagsController.sharedInstance.deleteHashtag(at: IndexPath(row: at, section: 0))
        HashtagsController.sharedInstance.removeHashtags(toRemove)
        self.dismiss(animated: true, completion: nil)
